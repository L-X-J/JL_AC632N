#ifndef CONFIG_BOARD_AC632N_RIDER_POST_BUILD_CFG_H
#define CONFIG_BOARD_AC632N_RIDER_POST_BUILD_CFG_H
...
#define CONFIG_UART_UPDATE_PIN                  PA00
...
#define CONFIG_UBOOT_DEBUG_PIN                  PA00  /* 排障：与应用 UART0 同脚 PA0 */

#ifndef CONFIG_BOARD_AC632N_RIDER_H
#define CONFIG_BOARD_AC632N_RIDER_H

#include "board_ac632n_rider_global_build_cfg.h"
...
/* Run only a two-second UART heartbeat while isolating early boot. */
#define RIDER_UART_HEARTBEAT_ONLY             1
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#define TCFG_ADKEY_ENABLE                   DISABLE_THIS_MOUDLE // PB7 belongs exclusively to M601
...
#define TCFG_TOUCH_KEY1_PORT 				NO_CONFIG_PORT // PB7 reserved for M601 1-Wire
...
#define TCFG_HANDSHAKE_IO_DATA2             NO_CONFIG_PORT// PB7 reserved for M601 1-Wire
/*
充电截止电压可选配置：
...
#define TCFG_USER_EDR_ENABLE                      0   //Rider only exposes BLE
...
// Product overrides are deliberately last so demo defaults cannot claim PB7
// or re-enable a second Bluetooth role when this header is reused.
...
#define USER_SUPPORT_PROFILE_A2DP 0
#undef USER_SUPPORT_PROFILE_AVCTP
#define USER_SUPPORT_PROFILE_AVCTP 0
#undef USER_SUPPORT_PROFILE_HID
#define USER_SUPPORT_PROFILE_HID 0
#undef USER_SUPPORT_PROFILE_PNP
#define USER_SUPPORT_PROFILE_PNP 0
#undef USER_SUPPORT_PROFILE_PBAP
#define USER_SUPPORT_PROFILE_PBAP 0
#undef USER_SUPPORT_PROFILE_MAP
#define USER_SUPPORT_PROFILE_MAP 0
#undef USER_SUPPORT_PROFILE_HCRP
#define USER_SUPPORT_PROFILE_HCRP 0
#undef TCFG_ADKEY_ENABLE
#define TCFG_ADKEY_ENABLE DISABLE_THIS_MOUDLE
#undef TCFG_TOUCH_KEY_ENABLE
#define TCFG_TOUCH_KEY_ENABLE DISABLE_THIS_MOUDLE
#undef TCFG_HANDSHAKE_ENABLE
#define TCFG_HANDSHAKE_ENABLE DISABLE
#undef TCFG_CHARGE_ENABLE
#define TCFG_CHARGE_ENABLE DISABLE_THIS_MOUDLE
#undef TCFG_AUDIO_ENABLE
#define TCFG_AUDIO_ENABLE DISABLE_THIS_MOUDLE
#undef TCFG_PC_ENABLE
#define TCFG_PC_ENABLE DISABLE_THIS_MOUDLE
